...
INSERT INTO animals(name, date_of_birth, escape_attempts, neutered, weight_kg) VALUES('Davimon', '2017-05-12', 5, true, 11);
...
UPDATE animals SET owner_id = (SELECT id FROM owners WHERE full_name = 'Bob') WHERE name IN ('Davimon', 'Plantmon');
...
INSERT INTO specializations(vets_id, species_id) VALUES((SELECT id FROM vets WHERE name = 'Stephanie Mendez'), (SELECT id FROM species WHERE name = 'Digimon')), ((SELECT id FROM vets WHERE name = 'Stephanie Mendez'), (SELECT id FROM species WHERE name = 'Pokemon'));
...
INSERT INTO visits(animals_id, vets_id, date_of_visit) VALUES((SELECT id FROM animals WHERE name = 'Davimon'), (SELECT id FROM vets WHERE name = 'Stephanie Mendez'), '2021-05-14');
...
INSERT INTO visits(animals_id, vets_id, date_of_visit) VALUES((SELECT id FROM animals WHERE name = 'Agumon'), (SELECT id FROM vets WHERE name = 'Jack Harkness'), '2020-10-03');
INSERT INTO visits(animals_id, vets_id, date_of_visit) VALUES((SELECT id FROM animals WHERE name = 'Agumon'), (SELECT id FROM vets WHERE name = 'Jack Harkness'), '2020-11-04');
